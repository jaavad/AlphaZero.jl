"""
An Experimental implementation: Monte Carlo DAG Search

This requires every state to have a unique hash
...
mutable struct Env{State, Oracle}
  ...
  function Env(gspec, oracle;
    ...
    new{S, typeof(oracle)}(
      ...
      total_simulations, effective_simulations, total_nodes_traversed, gspec)
  end
end
